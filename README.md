...
This fork removes upstream usage telemetry, the onboarding survey, and Community Hub integrations. The runtime does not send usage events to AnythingLLM or Mintplex Labs.

Depending on your setup, outbound connections may still occur to services you explicitly configure, such as LLM providers, embedding providers, vector databases, or model mirrors.
