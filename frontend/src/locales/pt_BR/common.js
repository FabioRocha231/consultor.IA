...
const TRANSLATIONS = {
  ...
  settings: {
    ...
    menu: {
      label: "Cardápio",
      description: "Gerencie os itens do cardápio do restaurante.",
      items: {
        new: "Novo item",
        edit: "Editar item",
      },
    ...
    orders: {
      label: "Pedidos",
      description: "Gerencie os pedidos recebidos pelo WhatsApp.",
      status: {
      ...
      errors: {
        ...
        idempotencyKeyRequired: "Cabeçalho Idempotency-Key obrigatório.",
      },
