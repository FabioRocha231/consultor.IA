...
const VECTOR_DB_PROVIDER_PRIVACY_MAP = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of consultor.IA.",
    ],
    logo: LanceDbLogo,
  },
};
...
const EMBEDDING_ENGINE_PROVIDER_PRIVACY_MAP = {
  native: {
    name: "consultor.IA Embedder",
    description: [
      "Your document text is embedded privately on this instance of consultor.IA.",
    ],
    logo: ConsultorIAIcon,
  },
  openai: {
    name: "OpenAI",
    policyUrl: "https://openai.com/policies/privacy-policy/",
